...
// Ejercicio 1
const busquedaXid = movies.find(i=>i.id == 843633)

console.log("El titulo de la pelicula buscada es: " + busquedaXid.title)

// Ejercicio 2

//const usuarioPregunta = prompt("¿Cuál es el título de la película que quieres buscar?")

//const busquedaXtitle = movies.find(i => i.title == usuarioPregunta)

//alert("La cantidad de votos que tiene la pelicula " + usuarioPregunta + " es: " + busquedaXtitle.vote_count)

console.log("Aca comienza el ejercicio 3")

//Ejercicio 3

const busquedaXpopularidad = movies.filter(el => el.popularity > 1000)

const nombres = busquedaXpopularidad.map(i => i.title)

console.log(nombres)

//Ejercicio 4

console.log("Aca comienza el ejercicio 4")

const mapeoNuevo = movies.map(el => el.title + " salio en la fecha " + el.release_date)

console.log(mapeoNuevo)
